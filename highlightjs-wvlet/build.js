...
// Create a simple minified version (remove comments and extra whitespace)
...
// Add a header comment to the minified version
const minifiedWithHeader = '/*! Wvlet syntax highlighting for highlight.js */\n' + minified;

fs.writeFileSync(path.join(__dirname, 'dist/wvlet.min.js'), minifiedWithHeader);
