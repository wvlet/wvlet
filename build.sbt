  ...
  .jvmSettings(
    ...
    libraryDependencies ++=
      Seq(
        ...
        "io.zonky.test.postgres" % "embedded-postgres-binaries-darwin-arm64v8" % "17.10.0" % Test,
        "io.zonky.test.postgres" % "embedded-postgres-binaries-linux-amd64"    % "17.10.0" % Test,
