...
object WvletBuildKeys {
  ...
  @transient
  lazy val stdlibGen =
    taskKey[Seq[File]]("Generate stdlib.scala from wvlet-stdlib .wv files")

  @transient
  lazy val sampleQueryGen =
    taskKey[Seq[File]]("Generate SampleQuery.scala for the playground")
