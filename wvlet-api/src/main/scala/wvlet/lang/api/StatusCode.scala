...
enum StatusCode(statusType: StatusType):
  ...
  case DUPLICATE_STAGE_NAME      extends StatusCode(StatusType.UserError)
  case INVALID_STAGE_INPUT       extends StatusCode(StatusType.UserError)
  case INVALID_FLOW_STRUCTURE    extends StatusCode(StatusType.UserError)
  case INVALID_SWITCH_CASE       extends StatusCode(StatusType.UserError)
  case INVALID_SPLIT_PERCENTAGES extends StatusCode(StatusType.UserError)
  case CIRCULAR_STAGE_DEPENDENCY extends StatusCode(StatusType.UserError)
