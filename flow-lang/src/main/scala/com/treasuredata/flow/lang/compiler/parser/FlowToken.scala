...
enum FlowToken(val tokenType: TokenType, val str: String):
  ...
  case OF extends FlowToken(Keyword, "of")
  ...
  case ON    extends FlowToken(Keyword, "on")
  case LEFT  extends FlowToken(Keyword, "left")
  case RIGHT extends FlowToken(Keyword, "right")
  case FULL  extends FlowToken(Keyword, "full")
  case INNER extends FlowToken(Keyword, "inner")
  case CROSS extends FlowToken(Keyword, "cross")
